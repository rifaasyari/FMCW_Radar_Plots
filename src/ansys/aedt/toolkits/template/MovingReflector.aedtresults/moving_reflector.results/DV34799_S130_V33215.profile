$begin 'Profile'
	$begin 'ProfileGroup'
		...
		$begin 'StartInfo'
			I(1, 'Start Time', '09/27/2023 15:03:35')
		...
		$begin 'ProfileGroup'
			...
			$begin 'ProfileGroup'
				...
				ProfileItem('', 0, 0, 0, 0, 295663, 'I(1, 0, \'Disk = 0 kBytes, 1 task, 1 core per task\')', true, true)
				...
				ProfileItem('Data Transfer', 0, 0, 0, 0, 91080, 'I(1, 0, \'Discrete frequency sweep\')', true, true)
		...
		$begin 'ProfileGroup'
			...
			ProfileItem('Frequency Sweep', 0, 0, 0, 0, 0, 'I(5, 1, \'Elapsed Time\', \'00:00:02\', 1, \'Average memory/process\', \'289 MB\', 1, \'Max memory/process\', \'289 MB\', 2, \'Max number of processes/frequency\', 0, false, 2, \'Total number of cores\', 1, false)', false, true)
		$end 'ProfileGroup'
		ProfileFootnote('I(2, 1, \'Stop Time\', \'09/27/2023 15:03:38\', 1, \'Status\', \'Normal Completion\')', 0)
	$end 'ProfileGroup'
$end 'Profile'
