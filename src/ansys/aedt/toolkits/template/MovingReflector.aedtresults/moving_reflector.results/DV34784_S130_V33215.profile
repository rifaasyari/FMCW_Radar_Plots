$begin 'Profile'
	$begin 'ProfileGroup'
		...
		$begin 'StartInfo'
			I(1, 'Start Time', '09/27/2023 15:03:25')
		...
		$begin 'ProfileGroup'
			...
			$begin 'ProfileGroup'
				...
				ProfileItem('', 0, 0, 0, 0, 295659, 'I(1, 0, \'Disk = 0 kBytes, 1 task, 1 core per task\')', true, true)
				...
				ProfileItem('Data Transfer', 1, 0, 0, 0, 91664, 'I(1, 0, \'Discrete frequency sweep\')', true, true)
