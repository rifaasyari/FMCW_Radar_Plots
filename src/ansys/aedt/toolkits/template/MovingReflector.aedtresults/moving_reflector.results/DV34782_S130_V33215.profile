$begin 'Profile'
	$begin 'ProfileGroup'
		...
		$begin 'StartInfo'
			I(1, 'Start Time', '09/27/2023 15:03:24')
		...
		$begin 'ProfileGroup'
			...
			$begin 'ProfileGroup'
				...
				ProfileItem('', 0, 0, 0, 0, 295707, 'I(1, 0, \'Disk = 0 kBytes, 1 task, 1 core per task\')', true, true)
				...
				ProfileItem('Data Transfer', 0, 0, 0, 0, 91476, 'I(1, 0, \'Discrete frequency sweep\')', true, true)
		...
		$end 'ProfileGroup'
		ProfileFootnote('I(2, 1, \'Stop Time\', \'09/27/2023 15:03:28\', 1, \'Status\', \'Normal Completion\')', 0)
	$end 'ProfileGroup'
$end 'Profile'
