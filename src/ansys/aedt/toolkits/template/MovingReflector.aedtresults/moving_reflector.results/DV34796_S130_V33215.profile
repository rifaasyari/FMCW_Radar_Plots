$begin 'Profile'
	$begin 'ProfileGroup'
		...
		$begin 'StartInfo'
			I(1, 'Start Time', '09/27/2023 15:03:32')
		...
		$begin 'ProfileGroup'
			...
			$begin 'ProfileGroup'
				...
				ProfileItem('', 0, 0, 0, 0, 295731, 'I(1, 0, \'Disk = 0 kBytes, 1 task, 1 core per task\')', true, true)
				ProfileItem('SBR Ray Stats', 0, 0, 0, 0, 0, 'I(1, 0, \'Num Launched = 270; Num Escaped = 270; Num Contributed = 270\')', false, true)
				ProfileItem('', 0, 0, 0, 0, 0, 'I(1, 0, \'(Refl Depth, Num Branches Escape/Terminate at) = (1,4); (2,116); (3,150)\')', false, true)
				ProfileItem('Data Transfer', 1, 0, 0, 0, 91256, 'I(1, 0, \'Discrete frequency sweep\')', true, true)
		...
		$begin 'ProfileGroup'
			...
			ProfileItem('Frequency Sweep', 0, 0, 0, 0, 0, 'I(5, 1, \'Elapsed Time\', \'00:00:04\', 1, \'Average memory/process\', \'289 MB\', 1, \'Max memory/process\', \'289 MB\', 2, \'Max number of processes/frequency\', 0, false, 2, \'Total number of cores\', 1, false)', false, true)
		$end 'ProfileGroup'
		ProfileFootnote('I(2, 1, \'Stop Time\', \'09/27/2023 15:03:36\', 1, \'Status\', \'Normal Completion\')', 0)
	$end 'ProfileGroup'
$end 'Profile'
