...
.. code::
    ...
    git clone https://github.com/ansys/pyaedt-toolkits-template.git
    cd pyaedt-toolkits-template
    python -m pip install --upgrade pip
    pip install -e .

Post issues
-----------
Use the `PyAEDT toolkit template issues <https://github.com/ansys/pyaedt-toolkits-template/issues>`_ page
